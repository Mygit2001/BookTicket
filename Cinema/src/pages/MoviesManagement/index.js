...
export default function MoviesManagement() {
  ...
  const columns = [
    ...
    { field: "Đạo diễn", hide: true, width: 200, renderCell: RenderCellExpand },
    { field: "Diễn viên", hide: true, width: 200, renderCell: RenderCellExpand },
    { field: "Quốc gia", hide: true, width: 200, renderCell: RenderCellExpand },
    { field: "Thể loại", hide: true, width: 200, renderCell: RenderCellExpand },
  ];
